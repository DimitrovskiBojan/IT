...
namespace IT_Aplikacija.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AddUserToRole()
        {
            ...
            model.Role = new List<string>() { "Admin", "Editor", "User" };
            return View(model);
        }
        [HttpPost]
        public ActionResult AddUserToRole(AddToRoleModel model)
        {
            ...
            if (user == null)
            {
                throw (new HttpException(404, "Не постои корисник со овој Email"));
            }
            UserManager.AddToRole(user.Id, model.Selected_Role);
